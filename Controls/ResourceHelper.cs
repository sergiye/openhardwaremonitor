...
using OpenHardwareMonitor.Properties;
...
namespace OpenHardwareMonitor.Controls
{
    public static class ResourceHelper
    {
        ...
        private static Cursor _dVSplitCursor = GetCursor(Resources.DVSplit);
        public static Cursor DVSplitCursor
        {
            get { return _dVSplitCursor; }
        }

		private static GifDecoder _loadingIcon = GetGifDecoder(Resources.loading_icon);
