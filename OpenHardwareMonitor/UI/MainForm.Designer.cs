namespace OpenHardwareMonitor.UI
{
    sealed partial class MainForm
    {
      ...
      this.celsiusMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.fahrenheitMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      ...
      this.log1sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log2sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log5sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log10sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log30sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log1minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log2minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log5minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log10minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log30minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log1hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log2hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.log6hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.updateIntervalMenuItem = new System.Windows.Forms.ToolStripMenuItem();
      this.updateInterval250msMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.updateInterval500msMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.updateInterval1sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.updateInterval2sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.updateInterval5sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.updateInterval10sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      ...
      this.perSessionFileRotationMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.dailyFileRotationMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.sensorValuesTimeWindowMenuItem = new System.Windows.Forms.ToolStripMenuItem();
      this.timeWindow30sMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow1minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow2minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow5minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow10minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow30minMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow1hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow2hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow6hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow12hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
      this.timeWindow24hMenuItem = new sergiye.Common.ToolStripRadioButtonMenuItem();
